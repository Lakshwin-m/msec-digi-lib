...
import { signInWithRegisterNumber, signInWithGoogle } from '@/lib/firebase/auth';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
          <span className="bg-white px-4 text-slate-400">Institutional Access Only</span>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center space-x-3 bg-white border-2 border-slate-100 hover:border-indigo-100 hover:bg-slate-50 py-4 rounded-2xl transition-all group"
      >
        ...
        <span className="text-xs font-black uppercase tracking-widest text-slate-600 group-hover:text-indigo-600">Continue with MSEC Google</span>
      </button>

      <div className="pt-6 text-center border-t border-slate-50">
        <p className="text-slate-500 font-medium text-sm">
          New to the archive? 
          <a href="/register" className="ml-2 text-indigo-600 font-black uppercase tracking-widest text-[10px] hover:underline">
            Register Identity →
          </a>
        </p>
      </div>
